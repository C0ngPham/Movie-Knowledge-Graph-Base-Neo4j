...
export default class MoviesApi {
  ...
  static getFeaturedMovies() {
    return Promise.all([
      axios.get(`${apiBaseURL}/movies/68721`),
      axios.get(`${apiBaseURL}/movies/9312`),
      axios.get(`${apiBaseURL}/movies/1788`),
      axios.get(`${apiBaseURL}/movies/604`)
    ]);
  }
  ...
  static getSearchMovie(name){
      return axios.get(`${apiBaseURL}/movies/title/${name}`)
  }
